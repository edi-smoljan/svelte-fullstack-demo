<script lang="ts">
    ...
    export let processDeletedTodoResult: (response: Response, form: HTMLFormElement) => void;
    export let processUpdatedTodoResult: (response: Response, form: HTMLFormElement) => void;
</script>
<style>
    .todo {
        display: grid;
...
<div class="todo" class:done="{todo.done}">
    <form action="/todos/{todo.uid}.json?_method=patch" method="post" use:enhance={{
        ...
        <button aria-label="Mark todo as{todo.done? '':' not'} done" class="toggle"></button>
    </form>
